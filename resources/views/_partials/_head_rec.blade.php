<div class="container border-bottom border-secondary d-none d-md-block">
    <div class="row my-5 ">
        <div class="col-4">
            <div class="row">
                <div class="col-3">
        ...
        <div class="col-4">
            <div class="row">
                ...
                <div class="col-9 text-center">
                    ...
                    <p class="text-secondary">Цена приёма будет как в клинике или ниже</p>
                </div>
            </div>
        </div>
        <div class="col-4">
            <div class="row">
                ...
                <div class="col-9 text-center">
                    ...
                    <p class="text-secondary">Только честные отзывы пользователей</p>
                </div>
            </div>
        </div>
    </div>
