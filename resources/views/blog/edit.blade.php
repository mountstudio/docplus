...
@section('content')
    ...
    <div class="container bg-white">
        <div class="row">
            <form class="col-12 py-5" action="{{ route('blog.update', $blog) }}" method="post"
                ...
                <div class="form-group">
                    <label class="col-12">Мини-описание статьи
                        <textarea class="form-control" name="excerpt" id="excerpt" cols="30" rows="4">
                            {{ $blog->excerpt }}
                        </textarea>
                    </label>
                </div>
                ...
                <button type="submit" class="btn btn-success col-auto">Редактировать</button>
            </form>
        </div>
    </div>
