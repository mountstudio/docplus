    ...
    <section>
        <div class="container py-5">
            ...
            <div class="row py-5 justify-content-center">
                <div class="col-10 border rounded shadow p-5 bg-info text-white position-relative">
                    <div class="backdrop index-1"></div>
                    <form action="" class="position-relative index-5">
                        <div class="form-group">
                            <select name="" class="form-control col-4" id="">
                        ...
                        <div class="form-group">
                            <input type="email" placeholder="Электронная почта" class="form-control col-4">
                        </div>
